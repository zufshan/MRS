...
movies_dict = pickle.load(open('C:\Movie-Recommender-System-master\MRSM-PRO\movie_dict.pkl', 'rb'))

movies = pd.DataFrame(movies_dict)
    
#import statemnt for similarity
similarity = pickle.load(open(r'C:\Movie-Recommender-System-master\MRSM-PRO\similarity.pkl', 'rb'))
